...
public interface OWMConfigResources {
	...
	String WRAPPER_KEY = "openweathermap";
	String TARGET_URL = "http://api.openweathermap.org";
	String TARGET_PATH_CITY = "/data/2.5/forecast/city"; // ? // Currently makes
															// a call against
															// city code as
															// suggested by
															// official website.
	...
	String QUERYPARAM_APPID_VALUE = "902ef182e47257b3782f4d7163ce6fbd"; // Also
																		// referred
																		// to as
																		// API
																		// Key
